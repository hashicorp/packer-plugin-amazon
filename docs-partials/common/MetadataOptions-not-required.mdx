<!-- Code generated from the comments of the MetadataOptions struct in common/run_config.go; DO NOT EDIT MANUALLY -->
...
- `http_put_response_hop_limit` (int32) - A numerical value to set an upper limit for the amount of hops allowed when communicating with IMDS endpoints.
  Defaults to 1.
...
<!-- End of code generated from the comments of the MetadataOptions struct in common/run_config.go; -->
