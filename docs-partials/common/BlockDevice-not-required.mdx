<!-- Code generated from the comments of the BlockDevice struct in common/block_device.go; DO NOT EDIT MANUALLY -->
...
<!-- End of code generated from the comments of the BlockDevice struct in common/block_device.go; -->
