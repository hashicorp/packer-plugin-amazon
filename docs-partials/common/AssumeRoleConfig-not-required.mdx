<!-- Code generated from the comments of the AssumeRoleConfig struct in common/access_config.go; DO NOT EDIT MANUALLY -->
...
<!-- End of code generated from the comments of the AssumeRoleConfig struct in common/access_config.go; -->
