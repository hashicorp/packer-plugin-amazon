<!-- Code generated from the comments of the RunConfig struct in common/run_config.go; DO NOT EDIT MANUALLY -->
...
- `capacity_reservation_market_type` (string) - The market type to use when launching instances with capacity reservations.
...
<!-- End of code generated from the comments of the RunConfig struct in common/run_config.go; -->
