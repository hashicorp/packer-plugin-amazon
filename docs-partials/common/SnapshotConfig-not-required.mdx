<!-- Code generated from the comments of the SnapshotConfig struct in common/snapshot_config.go; DO NOT EDIT MANUALLY -->
...
<!-- End of code generated from the comments of the SnapshotConfig struct in common/snapshot_config.go; -->
