...
- [amazon-ami](/docs/datasources/amazon/ami.mdx) - Filter and fetch an Amazon AMI to output all the AMI information.

- [amazon-secretsmanager](/docs/datasources/amazon/secretsmanager.mdx) - Retrieve information
