...
- [amazon-ebs](/docs/builders/amazon/ebs.mdx) - Create EBS-backed AMIs by
  launching a source AMI and re-packaging it into a new AMI after
  provisioning. If in doubt, use this builder, which is the easiest to get
  started with.

- [amazon-instance](/docs/builders/amazon/instance.mdx) - Create
  instance-store AMIs by launching and provisioning a source instance, then
  rebundling it and uploading it to S3.

- [amazon-chroot](/docs/builders/amazon/chroot.mdx) - Create EBS-backed AMIs
...
- [amazon-ebssurrogate](/docs/builders/amazon/ebssurrogate.mdx) - Create EBS
...
builder](/docs/builders/amazon/ebs.mdx). It is much easier to use and Amazon
...
- [amazon-ebsvolume](/docs/builders/amazon/ebsvolume.mdx) - Create EBS
