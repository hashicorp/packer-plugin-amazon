...
- [amazon-ebs](builders/amazon/ebs) - Create EBS-backed AMIs by
  launching a source AMI and re-packaging it into a new AMI after
  provisioning. If in doubt, use this builder, which is the easiest to get
  started with.

- [amazon-instance](builders/amazon/instance) - Create
  instance-store AMIs by launching and provisioning a source instance, then
  rebundling it and uploading it to S3.

- [amazon-chroot](builders/amazon/chroot) - Create EBS-backed AMIs
...
- [amazon-ebssurrogate](builders/amazon/ebssurrogate) - Create EBS
...
builder](builders/amazon/ebs). It is much easier to use and Amazon
...
- [amazon-ebsvolume](builders/amazon/ebsvolume) - Create EBS
