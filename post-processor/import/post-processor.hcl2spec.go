...
type FlatConfig struct {
	...
	FromSnapshot           *bool                             `mapstructure:"from_snapshot" cty:"from_snapshot" hcl:"from_snapshot"`
	FromSnapshotDeviceName *string                           `mapstructure:"from_snapshot_device_name" cty:"from_snapshot_device_name" hcl:"from_snapshot_device_name"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"from_snapshot":                 &hcldec.AttrSpec{Name: "from_snapshot", Type: cty.Bool, Required: false},
		"from_snapshot_device_name":     &hcldec.AttrSpec{Name: "from_snapshot_device_name", Type: cty.String, Required: false},
	}
	return s
}
