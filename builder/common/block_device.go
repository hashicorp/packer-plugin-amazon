...
type BlockDevice struct {
	...
	IOPS *int32 `mapstructure:"iops" required:"false"`
	...
	// for more information
	Throughput *int32 `mapstructure:"throughput" required:"false"`
...
var iopsRatios = map[ec2types.VolumeType]int32{
	ec2types.VolumeTypeIo1: 50,
	ec2types.VolumeTypeIo2: 500,
}
