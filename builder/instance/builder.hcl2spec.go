...
type FlatConfig struct {
	...
	CapacityReservationMarketType             *string                                     `mapstructure:"capacity_reservation_market_type" required:"false" cty:"capacity_reservation_market_type" hcl:"capacity_reservation_market_type"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"capacity_reservation_market_type": &hcldec.AttrSpec{Name: "capacity_reservation_market_type", Type: cty.String, Required: false},
