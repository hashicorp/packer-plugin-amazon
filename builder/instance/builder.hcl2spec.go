...
type FlatConfig struct {
	...
	AMISnapshotCopyCompletionDurationMinutes  *int64                                      `mapstructure:"snapshot_copy_completion_duration_minutes" required:"false" cty:"snapshot_copy_completion_duration_minutes" hcl:"snapshot_copy_completion_duration_minutes"`
	...
	BundleDestination                         *string                                     `mapstructure:"bundle_destination" required:"false" cty:"bundle_destination" hcl:"bundle_destination"`
	BundlePrefix                              *string                                     `mapstructure:"bundle_prefix" required:"false" cty:"bundle_prefix" hcl:"bundle_prefix"`
	BundleUploadCommand                       *string                                     `mapstructure:"bundle_upload_command" required:"false" cty:"bundle_upload_command" hcl:"bundle_upload_command"`
	BundleVolCommand                          *string                                     `mapstructure:"bundle_vol_command" required:"false" cty:"bundle_vol_command" hcl:"bundle_vol_command"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"snapshot_copy_completion_duration_minutes": &hcldec.AttrSpec{Name: "snapshot_copy_completion_duration_minutes", Type: cty.Number, Required: false},
		...
		"temporary_security_group_source_public_ip":      &hcldec.AttrSpec{Name: "temporary_security_group_source_public_ip", Type: cty.Bool, Required: false},
