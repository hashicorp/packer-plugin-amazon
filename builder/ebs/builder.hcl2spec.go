...
type FlatConfig struct {
	...
	SkipSourceInstanceTerminationWait         *bool                                       `mapstructure:"skip_source_instance_termination_wait" required:"false" cty:"skip_source_instance_termination_wait" hcl:"skip_source_instance_termination_wait"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"skip_source_instance_termination_wait": &hcldec.AttrSpec{Name: "skip_source_instance_termination_wait", Type: cty.Bool, Required: false},
