...
func (b *Builder) Run(ctx context.Context, ui packersdk.Ui, hook packersdk.Hook) (packersdk.Artifact, error) {
	...
	steps := []multistep.Step{
		...
		&awscommon.StepAMIRegionCopy{
			AccessConfig:                             &b.config.AccessConfig,
			Regions:                                  b.config.AMIConfig.AMIRegions,
			AMIKmsKeyId:                              b.config.AMIConfig.AMIKmsKeyId,
			RegionKeyIds:                             b.config.AMIConfig.AMIRegionKMSKeyIDs,
			EncryptBootVolume:                        b.config.AMIConfig.AMIEncryptBootVolume,
			Name:                                     b.config.AMIConfig.AMIName,
			OriginalRegion:                           *ec2conn.Config.Region,
			AMISkipBuildRegion:                       b.config.AMIConfig.AMISkipBuildRegion,
			AMISnapshotCopyCompletionDurationMinutes: b.config.AMIConfig.AMISnapshotCopyCompletionDurationMinutes,
		},
